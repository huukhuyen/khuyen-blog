...
export function SheetContent({ className, children, ...props }: ComponentProps<typeof Dialog.Content>): JSX.Element {
  return (
    <Dialog.Portal>
      ...
      <Card>
        <CardContent>
                  ...
                  />
                  <h2 className="!text-xl blog-sidebar__eyebrow font-bold text-center">Khuyên</h2>
        ...
        <Dialog.Close className="sheet-close" aria-label="Đóng menu"><X size={20} /></Dialog.Close>
      </Dialog.Content>
    </Dialog.Portal>
  );
}
