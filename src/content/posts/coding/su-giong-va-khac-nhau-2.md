...
*   Ngoài việc sử dụng trên`img`, nó còn được sử dụng ở nhiều tag khác, thường dùng cho trường hợp thay thế như_**tooltip**_,_**truncate text**_...
...
*   Không thể sử dụng`pseudo-elements` như`:before` và`:after` vì`<input />` là thẻ_**single tag**_
