---
title: "Một vài kinh nghiệm làm việc với React"
slug: "mot-vai-kinh-nghiem-lam-viec-voi-react"
category: "coding"
publishedAt: "2019-10-21"
summary: "Chào mọi người, lần này mình xin nối tiếp chủ đề\"vở sạch chữ đẹp\" như những tiết học trước. Bài viết lần này mình xin chia sẻ vài kinh nghiệm viết code React mà mình đã đúc kết qua một vài dự án."
featuredImage: "https://images.viblo.asia/ee76ad06-5fc3-442e-ab35-f5627088228b.png"
featuredImageAlt: "Một vài kinh nghiệm làm việc với React"
legacyPath: "/coding/mot-vai-kinh-nghiem-lam-viec-voi-react.html"
legacyAliases: ["/coding/mot-vai-kinh-nghiem-lam-viec-voi-react"]
source: "original"
embeds: []
---

Chào mọi người, lần này mình xin nối tiếp chủ đề _**"vở sạch chữ đẹp"**_ như những tiết học trước. Bài viết lần này mình xin chia sẻ vài kinh nghiệm viết code React mà mình đã đúc kết qua một vài dự án.

![Một vài kinh nghiệm làm việc với React](https://images.viblo.asia/ee76ad06-5fc3-442e-ab35-f5627088228b.png)
...
![Một vài kinh nghiệm làm việc với React](https://images.viblo.asia/dd0f5127-b84b-4cae-96ff-79cd746a60ee.png)
...
`JavaScript` khác với những ngôn ngữ như `C/C++, Java, PHP...` vì nó không phải là ngôn ngữ hướng đối tượng, mà là ngôn ngữ chức năng (_**function languge**_). Chính vì vậy React ở bản nâng cấp đầu năm vừa qua đã bỏ cách viết class (stateful) để hướng người dùng trở về đúng với mục đích của nó.

> _**Đoạn này mình chỉ chém gió theo suy nghĩ của mình thôi nhé**_

React từ phiên bản 16.8 khi chúng ta cài boilerplate template `create react app` xong sẽ thấy code ví dụ ở file `App.js` được viết theo kiểu `function` (stateless). Ở bản cập nhật này, React cũng đã đưa ra rất nhiều cải tiến, với tên [React Hooks](https://huukhuyen.netlify.app/coding/react-hooks-co-gi-thu-vi.html).

Câu trả lời thì rõ ràng rồi, nên chọn cách viết Stateless để định nghĩa component.

Thời buổi này phải dùng tool
----------------------------

![Một vài kinh nghiệm làm việc với React](https://images.viblo.asia/4b9946d9-5faf-40e9-811d-8925f7751d1e.png)
...
_Ở bài trước mình đã chia sẻ nhiều extension về bắt lỗi "vở sạch chữ đẹp" bài này mình chỉ chia sẻ những extension support cho chức năng nhé_
...
Trên đây là một vài chia sẻ của mình để làm việc với project React. Hi vọng sẽ giúp bạn dễ quản lý source và code sạch đẹp hơn.
